...
const EventCard = ({ event }) => {
    ...
    const bgImages = {
        ...
        "table tennis singles(m)": "/tabletennis1.jpg",
        "table tennis doubles(m)": "/tabletennis1.jpg",
        "table tennis singles(w)": "/tabletennis1.jpg",
        "table tennis doubles(w)": "/tabletennis1.jpg",

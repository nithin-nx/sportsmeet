...
const EventCard = ({ event }) => {
    ...
    const bgImages = {
        ...
        "table tennis single(m)": "/tabletennis1.jpg",
        "table tennis double(m)": "/tabletennis1.jpg",
        "table tennis single(w)": "/tabletennis1.jpg",
        "table tennis double(w)": "/tabletennis1.jpg",

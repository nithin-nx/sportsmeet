        ...
        >
            ...
            <div className="max-w-7xl mx-auto px-6 space-y-32 md:space-y-48 mt-20 relative z-30">
                ...
                <section>
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-12">
                        <div className="space-y-2">
                            <span className="text-[10px] font-black uppercase tracking-[0.5em] text-primary">Category 01</span>
                ...
                <section>
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-12">
                        <div className="space-y-2">
                            <span className="text-[10px] font-black uppercase tracking-[0.5em] text-accent-crimson">Category 02</span>
